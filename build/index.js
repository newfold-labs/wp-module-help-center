(() => {
	const e = {
			452: (e) => {
				const t = (function (e) {
					...
					function u(e, t, n, r) {
						const i = t && t.prototype instanceof k ? t : k,
							l = Object.create(i.prototype),
							a = new C(r || []);
						return s(l, '_invoke', { value: I(e, n, a) }), l;
					}
					function h(e, t, n) {
						try {
					...
					const v = Object.getPrototypeOf,
						y = v && v(v(N([])));
					y && y !== n && r.call(y, l) && (x = y);
					const E = (w.prototype = k.prototype = Object.create(x));
					function S(e) {
					...
					return (
						(b.prototype = w),
						s(E, 'constructor', { value: w, configurable: !0 }),
						s(w, 'constructor', { value: b, configurable: !0 }),
						(b.displayName = c(w, o, 'GeneratorFunction')),
						...
						(e.AsyncIterator = A),
						(e.async = function (t, n, r, s, i) {
							void 0 === i && (i = Promise);
							const l = new A(u(t, n, r, s), i);
			...
			974: (e, t) => {
				(() => {
					...
					e.r(r),
						e.d(r, {
							initializeNamespace: () => o,
							updateHiiveDebounceInstance: () => d,
							updateHiiveDebounceTime: () => p,
							updateHiiveEventsQueue: () => u,
							updateHiiveEventsQueueThreshold: () => h,
							updateHiiveUrls: () => c,
						});
					const s = {};
					e.r(s),
						e.d(s, {
							getHiiveBatchUrl: () => k,
							getHiiveDebounce: () => b,
							getHiiveEventsQueue: () => g,
							getHiiveEventsQueueThreshold: () => f,
							getHiiveSingleUrl: () => m,
						});
					...
					const w = 'newfold/ui-analytics',
						...
						v = (0, i.createReduxStore)(w, x);
					(0, i.select)(w) || (0, i.register)(v);
					const y = window.wp.apiFetch;
					const E = e.n(y);
					const S = (e) =>
							!!window?.nfdUIAnalytics?.hiive &&
							e in window.nfdUIAnalytics.hiive,
						A = (e) => e instanceof l,
						I = async (e) => {
							if (!e || !S(e)) {
								return !1;
							}
							const t = (0, i.select)(v).getHiiveBatchUrl(e);
							if (!t) {
								return !1;
							}
							const n = (0, i.select)(v).getHiiveEventsQueue(e);
							if (0 === n.length) {
								return !0;
							}
							(0, i.dispatch)(v).updateHiiveEventsQueue([], e);
							try {
								await E()({ url: t, method: 'POST', data: n });
							} catch (t) {
								console.error(t),
						...
						R = {
							initialize: async ({
								namespace: e,
								urls: { single: t, batch: n } = {},
								settings: {
									debounce: { time: r } = {},
									queue: { threshold: s = 100 } = {},
								} = {},
							}) =>
								!(
									!e ||
									(!S(e) &&
										((!t && !n) ||
											((0, i.dispatch)(
												v
											).initializeNamespace(e),
											(0, i.dispatch)(v).updateHiiveUrls(
												{ single: t, batch: n },
												e
											),
											(0, i.dispatch)(
												v
											).updateHiiveDebounceTime(r, e),
											(0, i.dispatch)(
												v
											).updateHiiveEventsQueueThreshold(
												s,
												e
											),
											window.nfdUIAnalytics?.hiive
							...
							validate: A,
							track: (e) => {
								if (!A(e) || !S(e.namespace)) {
									return !1;
								}
								const t = e.namespace;
								delete e.namespace;
								const n = (0, i.select)(v).getHiiveEventsQueue(
									t
								);
								n.push(e),
									(0, i.dispatch)(v).updateHiiveEventsQueue(
								...
								const r = (0, i.select)(
									v
								).getHiiveEventsQueueThreshold(t);
								return (
									r && r < n.length && I(t),
									((e) => {
										if (!e) {
										...
										t.time &&
											(clearInterval(t.instance),
											(0, i.dispatch)(
												v
											).updateHiiveDebounceInstance(
												setTimeout(() => {
													I(e),
														(0, i.dispatch)(
															v
							...
							send: async (e) => {
								...
								const t = e.namespace;
								delete e.namespace;
								const n = (0, i.select)(v).getHiiveSingleUrl(t);
								if (!n) {
									return !1;
								}
								try {
							...
							disableDebounce: (e) => {
								...
								const t = (0, i.select)(v).getHiiveDebounce(e);
								return (
									t.instance &&
										(clearInterval(t.instance),
										(0, i.dispatch)(
										...
										(0, i.dispatch)(
											v
										).updateHiiveDebounceTime(void 0, e)),
									!0
								);
							},
						};
	...
	(() => {
		...
		const x = 'newfold-ai/v1',
			v = {
				getSearchResult: (e, t, n) =>
					l()({
						path: x + '/search',
						method: 'POST',
						data: { user_prompt: e, identifier: t, extra: n },
					}),
				getDefaultSearchResult: () =>
					l()({ path: x + '/search/default', method: 'POST' }),
			},
			y = window.lodash,
			E = async (e, t) => {
				try {
					return await l()({
						...
						body: JSON.stringify({ query: e, brand: t }),
					});
				} catch (e) {
					return (
						console.error('Error in getMultiSearchResults:', e), {}
					);
				}
			},
			S = {
				...
				getHelpVisible: () =>
					'true' === localStorage.getItem('helpVisible'),
				persistResult: (e, t, n) => {
					if (!e || '' === e.trim()) {
						return;
					}
					const r = S.getResultInfo(),
						s = { searchInput: n, resultContent: e, postId: t };
					r.push(s),
				...
				getResultInfo: () => {
					const e = localStorage.getItem('helpResultContent');
					return e && R(e) ? JSON.parse(e) : [];
				},
				getSearchInput: () => localStorage.getItem('searchInput'),
				getFeatureFlag: (e) => localStorage.getItem(e),
				clearSearchInput() {
					localStorage.removeItem('searchInput');
				},
				setFeatureFlag(e, t) {
				...
				updateFeedbackStatus: (e) => {
					const t = S.getResultInfo().map((t) =>
						t.postId === e ? { ...t, feedbackSubmitted: !0 } : t
					);
					localStorage.setItem(
						'helpResultContent',
						JSON.stringify(t)
			...
			A = (e, t) => {
				const n = new c.HiiveEvent('wonder_help', e, t, 'wonder_help');
				c.HiiveAnalytics.send(n);
			},
			I = (t, n = 100, r = !1) => {
		...
		const N = window.ReactJSXRuntime,
			L = () => {
				const [t, n] = (0, e.useState)(!1);
				(0, e.useEffect)(() => {
					n(S.getResultInfo().length <= 0);
				}, []);
				const r = (0, u.__)(
					...
					{ displayedText: s } = I(r || '', 50, t);
				return (0, N.jsxs)('div', {
					role: 'region',
					'aria-labelledby': 'helpcenter-intro-heading',
					className: 'helpcenter-intro',
					style: {
						display: S.getResultInfo().length > 0 ? 'none' : 'flex',
					},
					children: [
			...
			P = ({ postId: t, source: n }) => {
				...
				(0, e.useEffect)(() => {
					s(''),
						(p.current.className = 'feedback-button no'),
						(h.current.className = 'feedback-button yes');
				}, [t]),
					(0, e.useEffect)(() => {
						if (
							((async () => {
								('helpful' !== r && 'notHelpful' !== r) ||
									(((e, t) => {
										l()({
											path: 'nfd-help-center/v1/feedback',
											method: 'POST',
											data: { post_id: e, status: t },
										});
									})(t, r),
									A('help_feedback_submitted', {
										label_key: 'type',
										type:
											'helpful' === r
												? 'positive'
		...
		function Q({ noResult: e, isNewEntry: t, questionBlock: n }) {
			return (0, N.jsxs)('div', {
				...
				children: [
					...
					(0, N.jsx)('div', {
						children: e && t ? S.getSearchInput() : n,
					}),
				],
			});
		}
		...
		function V(e, t = '') {
			...
			const r = {
				replace: (e, t) => {
					...
					return (
						(s = s.replace(F.caret, '$1')), (n = n.replace(e, s)), r
					);
				},
		...
		const F = {
			...
			fe = V(ge, 'u').replace(/punct/g, ce).getRegex(),
			me = V(ge, 'u').replace(/punct/g, de).getRegex(),
			ke =
			...
			ye = V(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/)
				...
				.getRegex(),
			Ee = V(te).replace('(?:--\x3e|$)', '--\x3e').getRegex(),
			Se = V(
			...
			Te = {
				...
				punctuation: pe,
				reflink: Re,
				reflinkSearch: V('reflink|nolink(?!\\()', 'g')
					.replace('reflink', Re)
					.replace('nolink', je)
					.getRegex(),
				tag: Se,
			...
			Le = {
				...Ne,
				br: V(oe).replace('{2,}', '*').getRegex(),
				text: V(Ne.text)
					.replace('\\b_', '\\b_| {2,}\\n')
					.replace(/\{2,\}/g, '*')
					.getRegex(),
			},
			Pe = { normal: se, gfm: le, pedantic: ae },
			ze = { normal: Te, gfm: Ne, breaks: Le, pedantic: Ce },
			_e = {
				'&': '&amp;',
				'<': '&lt;',
				'>': '&gt;',
		...
		function Be(e, t) {
			if (t) {
				if (F.escapeTest.test(e)) {
					return e.replace(F.escapeReplace, He);
				}
			} else if (F.escapeTestNoEncode.test(e)) {
				return e.replace(F.escapeReplaceNoEncode, He);
			}
			return e;
		}
		function qe(e) {
		...
		function Qe(e, t) {
			...
			for (; r < n.length; r++) {
				n[r] = n[r].trim().replace(F.slashPipe, '|');
			}
			return n;
		}
		function Oe(e, t, n) {
		...
		function De(e, t, n, r, s) {
			...
			return { type: 'image', raw: n, href: i, title: l, text: a };
		}
		class Ue {
			options;
			rules;
				...
				if (t) {
					...
					if (this.rules.other.endingHash.test(e)) {
						...
						this.options.pedantic
							? (e = t.trim())
							: (t &&
									!this.rules.other.endingSpaceChar.test(
										t
									)) ||
								(e = t.trim());
					}
				...
				if (t) {
					...
					for (; e; ) {
						...
						if (
							...
							const t = this.rules.other.nextBulletRegex(h),
								n = this.rules.other.hrRegex(h),
								s = this.rules.other.fencesBeginRegex(h),
								i = this.rules.other.headingBeginRegex(h),
								l = this.rules.other.htmlBeginRegex(h);
							for (; e; ) {
								const p = e.split('\n', 1)[0];
								let d;
								if (
								...
								if (
									d.search(this.rules.other.nonSpaceChar) >=
										h ||
									!c.trim()
								) {
									a += '\n' + d.slice(h);
						...
						let p,
							d = null;
						this.options.gfm &&
							((d = this.rules.other.listIsTask.exec(a)),
							d &&
								((p = '[ ] ' !== d[0]),
								(a = a.replace(
					...
					for (let e = 0; e < s.items.length; e++) {
						if (
							...
							const t = s.items[e].tokens.filter(
									(e) => 'space' === e.type
								),
								n =
									t.length > 0 &&
			...
			reflink(e, t) {
				...
				if (
					...
					return De(n, e, n[0], this.lexer, this.rules);
				}
			}
			emStrong(e, t, n = '') {
		...
		class Ve {
			...
			constructor(e) {
				(this.tokens = []),
					...
					(this.options.tokenizer =
						this.options.tokenizer || new Ue()),
					(this.tokenizer = this.options.tokenizer),
					(this.tokenizer.options = this.options),
					(this.tokenizer.lexer = this),
					(this.inlineQueue = []),
					(this.state = { inLink: !1, inRawBlock: !1, top: !0 });
				const t = { other: F, block: Pe.normal, inline: ze.normal };
				this.options.pedantic
					? ((t.block = Pe.pedantic), (t.inline = ze.pedantic))
					: this.options.gfm &&
						((t.block = Pe.gfm),
						this.options.breaks
							? (t.inline = ze.breaks)
			...
			inlineTokens(e, t = []) {
				...
				for (; e; ) {
					...
					if ((r = this.tokenizer.emStrong(e, n, i))) {
						(e = e.substring(r.raw.length)), t.push(r);
						continue;
					}
		...
		class Fe {
			...
			code({ text: e, lang: t, escaped: n }) {
				const r = (t || '').match(F.notSpaceStart)?.[0],
		...
		class Ge {
			...
			parseInline(e, t = this.renderer) {
				...
				for (let r = 0; r < e.length; r++) {
					const s = e[r];
					if (this.options.extensions?.renderers?.[s.type]) {
						const e = this.options.extensions.renderers[
							s.type
						].call({ parser: this }, s);
						if (
							!1 !== e ||
		...
		const We = new (class {
				...
				return (
					e.forEach((e) => {
						...
						if (
							...
							const t =
								this.defaults.renderer || new Fe(this.defaults);
						...
						if (e.hooks) {
							const t = this.defaults.hooks || new Ye();
							for (const n in e.hooks) {
								if (!(n in t)) {
									throw new Error(
										`hook '${n}' does not exist`
									);
								}
			...
			lexer(e, t) {
				return Ve.lex(e, t ?? this.defaults);
			}
			parser(e, t) {
			...
			parseMarkdown(e) {
				return (t, n) => {
					...
					if (s.async) {
						return Promise.resolve(
							s.hooks ? s.hooks.preprocess(t) : t
						)
							.then((e) => l(e, s))
							.then((e) =>
		...
		(Je.options = Je.setOptions =
			function (e) {
				return (
					We.setOptions(e),
					(Je.defaults = We.defaults),
					D(Je.defaults),
					Je
				);
			}),
			(Je.getDefaults = function () {
				return {
					async: !1,
					breaks: !1,
					extensions: null,
			...
			(Je.walkTokens = function (e, t) {
				return We.walkTokens(e, t);
			}),
			(Je.parseInline = We.parseInline),
			(Je.Parser = Ge),
			(Je.parser = Ge.parse),
			(Je.Renderer = Fe),
			(Je.TextRenderer = Me),
		...
		const Xe = ({
				...
				const g = h && u === S.getResultInfo().length - 1,
					f = (0, e.useRef)(null),
					[m, k] = (0, e.useState)(!1);
				(0, e.useEffect)(() => {
					((g && f.current) || a) && b();
				...
				const b = () => {
						const e = window.innerHeight - 332;
						f.current.style.minHeight = `${e}px`;
						const t = p.current.scrollHeight;
						p.current.scrollBy({
							top: t,
							left: 0,
							behavior: 'smooth',
					...
					{ displayedText: w, isComplete: x } = I(t || '', 50, m),
					v = (0, e.useMemo)(() => {
						const e = ((e) => {
							if (e) {
				...
				return (0, N.jsxs)('div', {
					...
					children: [
						...
						!n &&
							...
							x &&
							t.length > 0 &&
							(0, N.jsx)(P, { postId: r, source: s }),
					],
				});
			},
			Ze = ({ isNewResult: t }) => {
				const n = (0, e.useRef)(null),
					r = window?.nfdHelpCenter?.resourceLink || '#',
					s = (0, u.__)(
				...
				return (0, N.jsxs)('div', {
					...
					className: 'helpcenter-response-block',
					children: [
						(0, N.jsx)(Q, { noResult: !0, isNewEntry: t }),
						(0, N.jsxs)('div', {
							className: 'helpcenter-result-block',
							children: [
								(0, N.jsx)('div', {
									className:
										'helpcenter-result-block__aistars',
									children: (0, N.jsx)(C, {}),
								}),
								(0, N.jsxs)('div', {
									children: [
							...
							a?.length > 0 &&
								a.map((a, o) =>
									(0, N.jsx)(
										Xe,
										{
											content: a.resultContent,
											noResult: t,
											postId: a.postId,
											source: l,
											showFeedbackSection:
												!a.resultContent.includes(
													'do not possess the answer'
												),
											questionBlock: a.searchInput,
											isLoading: i,
											loadingQuery: n,
											loadingIndex: r,
											index: o,
		...
		const it = ({
			...
			lt = (t) => {
				const [n, r] = (0, e.useState)({
					...
					a = (() => {
						const e =
							window.NewfoldRuntime?.plugin?.brand || 'wordpress';
						return e.includes('hostgator') &&
							window.NewfoldRuntime?.plugin?.region
							? e + '-' + window.NewfoldRuntime?.plugin?.region
							: e;
					})();
				(0, e.useEffect)(() => {
					o();
					const e = () => {
						r((e) => ({ ...e, visible: S.getHelpVisible() }));
					};
					return (
					...
					(0, e.useEffect)(() => {
						!(function (e, t, n) {
							...
							n &&
								t?.current &&
								(r = `${t.current.getBoundingClientRect().height}px`),
								e?.current &&
									(e.current.style.paddingBottom = r);
						})(l, s, n.showSuggestions);
					}, [n.showSuggestions]);
				const o = async () => {
						try {
							const e = await (window.NewfoldRuntime?.capabilities
								?.canAccessHelpCenter || !1);
							r((t) => ({ ...t, helpEnabled: e }));
						} catch (e) {
							r((e) => ({ ...e, helpEnabled: !1 }));
						}
					...
					c = (e, t, n, s = 'kb') => {
						const i = e
							...
							: '';
						S.persistResult(i, t, n),
							r((e) => ({
								...e,
								resultContent: S.getResultInfo(),
							})),
							t &&
								(r((e) => ({
									...e,
					...
					h = (0, e.useMemo)(
						() =>
							(0, y.debounce)(async (e) => {
								if (e) {
									try {
										const t = await E(e, a),
											n = t?.results?.[0]?.grouped_hits;
										n &&
											r((e) => ({
												...e,
												multiResults: { hits: n },
										...
										console.error(
											'Error fetching debounced results:',
											e
										);
									}
								} else {
					...
					p = async () => {
						try {
							const e = S.getResultInfo();
							e && r((t) => ({ ...t, resultContent: e }));
							const t = await E(n.searchInput, a);
							r((e) => ({
								...e,
								showSuggestions: !0,
								initComplete: !0,
								multiResults: {
									hits: t?.results?.[0]?.grouped_hits,
								},
							}));
						} catch (e) {
					...
					d = (e) =>
						!!(
							...
							(function (e, t, n) {
								...
								n.searchInput,
								e[0]?.text_match_info?.tokens_matched,
								e[0]?.text_match_info?.fields_matched
							)
						) &&
						(c(
							e[0].document.post_content,
							e[0].document.post_id || e[0].document.id,
							n.searchInput
						),
						!0);
				return n.helpEnabled && n.visible
					? (0, N.jsxs)('div', {
							...
							children: [
								...
								n.showSuggestions &&
									(0, N.jsx)(it, {
										suggestionsRef: s,
										multiResults: n.multiResults,
										handleSuggestionsClick: (e, t) => {
											r((e) => ({
												...e,
												showSuggestions: !1,
											})),
										...
										(() => {
											...
											(await (async () => {
												r((e) => ({
													...
													isLoading: !0,
													showSuggestions: !1,
													loadingQuery: e.searchInput,
													loadingIndex:
														e.resultContent.length,
												}));
												try {
													let e =
														n.multiResults
		...
		const dt = function () {
			...
			gt = ({ onClose: t }) => (
				(0, e.useEffect)(() => {
					const e =
						!window.newfoldHelpCenter?.closeOnLoad &&
						S.getHelpVisible();
					wt(e);
				}, []),
				(0, N.jsxs)('div', {
							...
							children: [
								(0, N.jsxs)('h3', {
									...
									children: [
										(0, N.jsx)('span', {
											className:
												'nfd-hc-modal__header__heading__icon',
											children: (0, N.jsx)(w, {}),
										}),
										(0, N.jsx)('span', {
											children: (0, u.__)(
								...
								(0, N.jsx)('button', {
									...
									className:
										'nfd-hc-modal__header__close-button',
									onClick: () => {
										t();
									},
									children: (0, N.jsx)(k, {
		...
		o()(() => {
			window?.nfdHelpCenter?.restUrl &&
				c.HiiveAnalytics.initialize({
					...
					dependencies: { wpData: s(), wpApiFetch: l() },
				});
		});
		const bt = document.getElementById('wpcontent'),
			wt = (e) => {
				bt.classList.toggle('wpcontent-container', e),
					document
						.getElementById('nfd-help-center')
						.classList.toggle('help-container', e),
					S.updateHelpVisible(e),
					window.dispatchEvent(new Event('storage')),
					e || S.clearSearchInput();
			};
		window.newfoldEmbeddedHelp = {
			toggleNFDLaunchedEmbeddedHelp: () => {
				(() => {
					const e = S.getHelpVisible();
					if (Object.is(e, void 0)) {
						return (
							wt(!0),
							void A('help_sidebar_opened', {
								page: window.location.href.toString(),
							})
						);
					}
					e ||
						A('help_sidebar_opened', {
							page: window.location.href.toString(),
						}),
						wt(!e);
				})();
			...
			renderEmbeddedHelp: () => {
				...
				(t.id = 'nfd-help-center'),
					(t.style.display = 'none'),
					bt.appendChild(t);
				const n = document.getElementById('nfd-help-center');
				null !== n &&
					('undefined' !== e.createRoot
						? (0, e.createRoot)(n).render(
								(0, N.jsx)(gt, {
									onClose: () => {
										wt(!1);
									},
		...
		const xt = (0, t.subscribe)(() => {
			document.getElementById('nfd-help-menu-button-wrapper')
				...
				: o()(() => {
						...
						(n.id = 'nfd-help-menu-button-wrapper'),
		...
		window.newfoldEmbeddedHelp.renderEmbeddedHelp(),
			(window.newfoldEmbeddedHelp.launchNFDEmbeddedHelpQuery = function (
				...
				const n = S.getHelpVisible();
				S.persistSearchInput(e),
					'true' !== n &&
						t &&
						(window.newfoldEmbeddedHelp.renderEmbeddedHelp(),
						wt(!0));
				const r = new KeyboardEvent('keydown', {
					...
					s = document.getElementById('nfd-help-center');
				let i = 0;
				const l = setInterval(() => {
					if (
						(i++,
						...
						const t = document.getElementById('search-input-box');
						(t.value = e),
							t.focus(),
			...
			document.addEventListener('click', (e) => {
				try {
					e.target?.dataset?.nfdhelpcenterquery &&
						'' !== e.target.dataset.nfdhelpcenterquery.trim() &&
						window.newfoldEmbeddedHelp.launchNFDEmbeddedHelpQuery(
							e.target.dataset.nfdhelpcenterquery,
							!0
						);
				} catch (e) {
					console.error('Error launching help center via query:', e);
				}
			});
	})();
})();
