# Agent guidance – wp-module-help-center

This file gives AI agents a quick orientation to the repo. For full detail, see the **docs/** directory.

## What this project is

- **wp-module-help-center** – Help center for Newfold brand plugins. Registers with the Newfold Module Loader; depends on wp-module-ai, wp-module-data, wp-module-features, typesense/typesense-php. Maintained by Newfold Labs.

- **Stack:** PHP 7.3+. See docs/dependencies.md.

- **Architecture:** Registers with the loader; provides help center UI and search (Typesense). See docs/integration.md.
